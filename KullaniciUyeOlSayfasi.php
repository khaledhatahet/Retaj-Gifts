...
<head>
    ...
    <link rel="stylesheet" href="CSS/KullaniciUyeOl.css">
...
<body>
    ...
    <article>
    <div class="loginSayfasininAlani">
        <img src="Resimler/Asset 1.png" width="79" height="81" class="loginFoto">
        <p class="GirisYazisi">Üye Ol</p>
        <div class="formAlani">
            <table>
                <form method="POST" action="">
                    <tr>
                        <td><input type="text" placeholder="Ad" id="ad" name="ad" required></td>
                    </tr>
                    <tr>
                        <td><input type="text" placeholder="Soyad" id="soyad" name="soyad" required></td>
                    </tr>
                    <tr>
                        <td><input type="text" placeholder="Email" id="email" name="email" required></td>
                    </tr>
                    <tr>
                        <td><input type="password" placeholder="Şifre" id="password" name="password" required></td>
                    </tr>
                    <tr>
                        <td><input type="submit" value="Üye Ol" name="gonder" id="girisButonu"></td>
                    </tr>
                </form>
            </table>
        </div>
        <p style="color: #707070;  text-align: right; margin-right:20px"> Giriş yapmak için <a href="KullaniciGirisSayfasi.php" style=" text-decoration:underline; color: #1174AE;">Tıklayınız</a>. </p>
    </div>
    </article>
    ...
    <?php
        ...
        if(isset($_POST["gonder"])){
            ...
            $res = mysqli_query($veritabaniBaglantisi , "SELECT * FROM user WHERE email= '$email'");
            ...
            $Ekle = mysqli_query($veritabaniBaglantisi , "INSERT INTO user(ad,soyad,email,password) VALUES('$ad','$soyad','$email','$password')");
