...
<body>
                ...
                <?php
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                        <a href="urun_sil.php?id=<?php echo $kayitlar["id"];?>"><button type="button" class="sil">Sil</button></a>
                        </td>
                    </tr>
                   <?php
                        }
    ...
    <div class="SayfalamaAlaniIciNumaralandirmaAlaniKapsayicisi">
        ...
        if ($GelenSayfalama > 1) {
            echo "<span class='Pasif'><a href='Urunleri_Sil.php?Sayfalama=1&ara=$GelenKelime'> << </a></span>";
            $SayfalamaIcinSayfaDegeriniBirGeriAl = $GelenSayfalama-1;
            echo " <span class='Pasif'><a href='Urunleri_Sil.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirGeriAl&ara=$GelenKelime'> < </a></span>";
        ...
        for($SayfalamaIcinSayfaIndexDeger = $GelenSayfalama-$SayfalamaIcinSolVeSagButonSayisi;$SayfalamaIcinSayfaIndexDeger <= $GelenSayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDeger++){
            ...
            if(($SayfalamaIcinSayfaIndexDeger > 0) and ($SayfalamaIcinSayfaIndexDeger <= $BulunanSayfaSayisi)){
                ...
                if($SayfalamaIcinSayfaIndexDeger == $GelenSayfalama){
                    ...
                    echo "<span class='Pasif'><a href='Urunleri_Sil.php?Sayfalama=" . $SayfalamaIcinSayfaIndexDeger . "&ara=$GelenKelime'>" . $SayfalamaIcinSayfaIndexDeger . "</a></span>";
        ...
        if($GelenSayfalama!=$BulunanSayfaSayisi){
            ...
            echo " <span class='Pasif'><a href='Urunleri_Sil.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirIleriAl&ara=$GelenKelime'> > </a></span>";
            echo "<span class='Pasif'><a href='Urunleri_Sil.php?Sayfalama=$BulunanSayfaSayisi&ara=$GelenKelime'> >> </a></span>";
