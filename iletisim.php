...
<head>
    ...
    <link rel="stylesheet" href="CSS/iletisim_style.css">
    <link
      rel="stylesheet"
...
<body>
    ...
    <div class="header" id="head">
        ...
        <div class="Harita">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3009.6433281637374!2d28.787075815363384!3d41.033058579298235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa438a39f52db%3A0xa4eb20ddc406fa96!2s%C4%B0stanbul%20Sabahattin%20Zaim%20%C3%9Cniversitesi!5e0!3m2!1str!2str!4v1618516996428!5m2!1str!2str" width="1366" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>

        <div class="form_kismi">
            <table>
                <form class="iletisimFormu" action="sonuc.php" method="post">
                <tr>
                    <td><input type="text"  placeholder="Ad Soyad" name="adisoyadi"></td>
                </tr>
                <tr>
                    <td><input type="Email"  placeholder="Email" name="emailadresi"></td>
                </tr>
                <tr>
                    <td><input type="text"  placeholder="Telefon" name="telefon"></td>
                </tr>
                <tr>
                    <td><input type="text" placeholder="Konu" name="konusu"></td>
                </tr>
                <tr>
                    <td><textarea id="" cols="30" rows="10" placeholder="Mesaj" name="mesaji"></textarea></td>
                </tr>
                <tr>
