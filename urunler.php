...
if(isset($_GET["kategori"])){
  ...
  $ToplamKayitSayisiSorgusu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM urun WHERE KategoriAdi='$GelenKategori' AND urunadi LIKE '%$GelenKelime%'");
...
if(isset($_GET["kategori"])){
  $GelenKategori = $_GET["kategori"];
  $UrunSorgusu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM urun WHERE KategoriAdi='$GelenKategori' AND urunadi LIKE '%$GelenKelime%' ORDER BY id ASC LIMIT $SayfalamayaBaslanacakKayitSayisi , $SayfaBasinaGosterilecekKayitSayisi");

  }else{
    $UrunSorgusu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM urun WHERE urunadi LIKE '%$GelenKelime%'  ORDER BY id ASC LIMIT $SayfalamayaBaslanacakKayitSayisi , $SayfaBasinaGosterilecekKayitSayisi");
...
<head>
    ...
    <link rel="stylesheet" href="CSS/urunler_style.css">
    <link
      rel="stylesheet"
...
<body>
    ...
    <div class="header" id="head">
        ...
        <aside>         
              ...
              $KategoriSorgusu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM kategori");
              while($kategoriler = mysqli_fetch_assoc($KategoriSorgusu)){
              ?>
            <ul>
                <li><a href="urunler.php?kategori=<?php echo $kategoriler['KategoriAdi']; ?>"><?php echo $kategoriler['KategoriAdi']; ?></a></li>
            </ul>
            <?php
              }
            ?>
            ...
            <div class="urunler_kismi">
                <table>
                    ...
                    <tr>
                        ...
                        $urunler = mysqli_fetch_assoc($UrunSorgusu);
                       if(@$urunler["Anafoto"] != ""){
                         ?>
                        <td>
                          <a href="urun.php?id=<?php echo $urunler["id"]; ?>"> 
                          <div class="urun">
                                <div  class="urun_fotografi" >
                                    <img class="foto1" src="AdminPaneli/Resimler/<?php echo Filtre($urunler["Anafoto"]) ?>">
                                    <?php if($urunler["KucukFotograf1"] != ""){ ?>

                                    <img class="foto2" src="AdminPaneli/Resimler/<?php echo Filtre($urunler["KucukFotograf1"]) ?>">
                                    <?php } else{?>
                                    <img class="foto2" src="AdminPaneli/Resimler/<?php echo Filtre($urunler["Anafoto"]) ?>">
                                    <?php  } ?>


                                </div>
                                <label class="urun_adi"> <?php echo $urunler['urunadi']; ?></label>
                                <div class="sepeteEkle" style="position:relative;bottom:20px">
                                    <a href="sepeteEkle.php?Urunid=<?php echo $urunler["id"]; ?>"> 
                                        <button class="sepeteEkleButonu">Sepete Ekle</button>
                                    </a>
                                </div>
                          </div>
                            </a> 
    ...
    <div class="SayfalamaAlaniIciNumaralandirmaAlaniKapsayicisi">
        ...
        if ($GelenSayfalama > 1) {
          if(isset($_GET["kategori"])){
            $GelenKategori = $_GET["kategori"];
            echo "<span class='Pasif'><a href='urunler.php?Sayfalama=1&ara=$GelenKelime&kategori=$GelenKategori'> << </a></span>";

          }else{
            echo "<span class='Pasif'><a href='urunler.php?Sayfalama=1&ara=$GelenKelime'> << </a></span>";

          }
            $SayfalamaIcinSayfaDegeriniBirGeriAl = $GelenSayfalama-1;
            if(isset($_GET["kategori"])){
              $GelenKategori = $_GET["kategori"];
              echo " <span class='Pasif'><a href='urunler.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirGeriAl&ara=$GelenKelime&kategori=$GelenKategori'> < </a></span>";

            }else{
              echo " <span class='Pasif'><a href='urunler.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirGeriAl&ara=$GelenKelime'> < </a></span>";
            }
        }
        ...
        for($SayfalamaIcinSayfaIndexDeger = $GelenSayfalama-$SayfalamaIcinSolVeSagButonSayisi;$SayfalamaIcinSayfaIndexDeger <= $GelenSayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDeger++){
            ...
            if(($SayfalamaIcinSayfaIndexDeger > 0) and ($SayfalamaIcinSayfaIndexDeger <= $BulunanSayfaSayisi)){
                ...
                if($SayfalamaIcinSayfaIndexDeger == $GelenSayfalama){
                  ...
                  if(isset($_GET["kategori"])){
                    $GelenKategori = $_GET["kategori"];
                    echo "<span class='Pasif'><a href='urunler.php?Sayfalama=" . $SayfalamaIcinSayfaIndexDeger . "&ara=$GelenKelime&kategori=$GelenKategori'>" . $SayfalamaIcinSayfaIndexDeger . "</a></span>";
      
                  }else{
                    echo "<span class='Pasif'><a href='urunler.php?Sayfalama=" . $SayfalamaIcinSayfaIndexDeger . "&ara=$GelenKelime'>" . $SayfalamaIcinSayfaIndexDeger . "</a></span>";
                  }
        ...
        if($GelenSayfalama!=$BulunanSayfaSayisi){
            ...
            if(isset($_GET["kategori"])){
              $GelenKategori = $_GET["kategori"];
              echo " <span class='Pasif'><a href='urunler.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirIleriAl&ara=$GelenKelime&kategori=$GelenKategori'> > </a></span>";
              echo "<span class='Pasif'><a href='urunler.php?Sayfalama=$BulunanSayfaSayisi&ara=$GelenKelime&kategori=$GelenKategori'> >> </a></span>";
            }else{
              echo " <span class='Pasif'><a href='urunler.php?Sayfalama=$SayfalamaIcinSayfaDegeriniBirIleriAl&ara=$GelenKelime'> > </a></span>";
              echo "<span class='Pasif'><a href='urunler.php?Sayfalama=$BulunanSayfaSayisi&ara=$GelenKelime'> >> </a></span>";
              }
