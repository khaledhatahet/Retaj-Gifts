        ...
        <a id="logo" href="index.php"><img src="resimler/logo.png" alt="Logo"></a>
            ...
            <form action="urunler.php" method="Get">
                <input type="search" name="ara" id="ara" placeholder="Ara...">
                      ...
                      <div id="slayt" class="owl-carousel owl-theme">

                      <?php 
                      $KategorileriGetir = mysqli_query($veritabaniBaglantisi , "SELECT DISTINCT KategoriAdi FROM urun");
                      $kategoriSayisi = mysqli_num_rows($KategorileriGetir);
                      for($i = 0 ; $i < $kategoriSayisi ; $i++){
                        $kategoriler = mysqli_fetch_assoc($KategorileriGetir);
                        $kategori = $kategoriler["KategoriAdi"];
                      $SlayticinSorgu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM urun WHERE KategoriAdi='$kategori' LIMIT 1");
                        while($urunler  = mysqli_fetch_assoc($SlayticinSorgu)){
                      ?>
                        <div class="item">
                          <div class="BuyukSlayt">
                            <div class="FotografKismi">
                                <img src="AdminPaneli/Resimler/<?php echo $urunler['Anafoto']; ?>" alt="">
                            </div>
                            <div class="AciklamaKismi">
                                    <h1><?php echo $urunler['KategoriAdi']; ?></h1>
                            </div>
                          </div>
                              </div>
                        <?php } } ?>
          ...
          <div class="kategoriler_kismi">
            <h2> Kategoriler</h2>
            <svg xmlns="http://www.w3.org/2000/svg" width="199.92" height="3" viewBox="0 0 199.92 3" id="Line_2">
              <line id="Line_2" data-name="Line 2" x2="199.92" transform="translate(0 1.5)" fill="none" stroke="#1174ae" stroke-width="3"/>
            </svg>
           
           <table width="1366px" class="kategoritablo">
             <?php
              $Baslangic = 0;
              $Bitis =2;

                     $KategorileriGetir1 = mysqli_query($veritabaniBaglantisi , "SELECT DISTINCT KategoriAdi FROM urun");
                      $kategoriSayisi1 = mysqli_num_rows($KategorileriGetir1);
           ...
           <?php
            ...
            for($sutun = $Baslangic ; $sutun< $Bitis ; $sutun++){
              $kategoriler1 = mysqli_fetch_assoc($KategorileriGetir1);
              $kategori1 = $kategoriler1["KategoriAdi"];
              $ListeinSorgu = mysqli_query($veritabaniBaglantisi , "SELECT * FROM urun WHERE KategoriAdi='$kategori1' LIMIT 1");
            $urunler1  = mysqli_fetch_assoc($ListeinSorgu);
              if($kategori1 != ""){
           ?>
         <td>
         <a href="urunler.php?kategori=<?php echo $kategori1; ?>" class="kategorilerdiv">
           <div class="BestKategoriler">
           <div class="KategoriFotografKismi">
           <img src="AdminPaneli/Resimler/<?php echo $urunler1['Anafoto']; ?>" alt="">

               </div>
                 <div class="KategoriAciklamaKismi">
                 <h1><?php echo $urunler1['KategoriAdi']; ?></h1>
          ...
          <div class="container">
            ...
            <div class="row">
          <div id="slayt2" class="owl-carousel owl-theme">
          <?php
            ...
            <div class="item">
              ...
              <div class="col-md-3">
                <div class="product">
                  ...
                  <div class="sepeteEkle" style="position:relative;bottom:120px">
                  <a href="sepeteEkle.php?Urunid=<?php echo $kayitlar["id"]; ?>"> 
