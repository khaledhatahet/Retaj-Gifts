...
<body>
    ...
    <div class="loginSayfasininAlani">
        ...
        <div class="formAlani">
            <table>
                <form method="POST" action="kullaniciGiris.php">
                    <tr>
        ...
        <p style="color: #707070;  text-align: right; margin-right:20px"> Hesabınız yoksa üye olmak için <a href="KullaniciUyeOlSayfasi.php" style=" text-decoration:underline; color: #1174AE;">Tıklayınız</a>. </p>
    </div>
    </article>
